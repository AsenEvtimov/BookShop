...
<body>
	...
	<c:if test="${userName !=null }">
		<p>View Shopping Cart for User ${userName}&nbsp;
		<a href="LoginServlet?action=logOut">Log Out</a></p>			
	</c:if>	
		<table border="1">
			<tr>
				<th>Id</th>
			...
			<tr>			
				...
				<td>${item.value}</td>				
				<td>
				<a href="BookServlet?action=addQuantityToCart&bookId=${item.key.id}">Add</a> <br></br>
				<a href="BookServlet?action=removeQuantityFromCart&bookId=${item.key.id}">Remove</a>
				</td>
				<td>
